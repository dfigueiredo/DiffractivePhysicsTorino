...
// Mon Mar 21 18:31:35 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/MBPythiaZ2_v1_7.root
//////////////////////////////////////////////////////////

#ifndef MB_efficiency_Class.C_h
#define MB_efficiency_Class.C_h
...
public :
 ...
 //vector<double>  etaOfTracksPT_gen;
   ...
   MB_efficiency_Class.C(TTree *tree=0);
   virtual ~MB_efficiency_Class.C();
...
#ifdef MB_efficiency_Class.C_cxx
MB_efficiency_Class.C::MB_efficiency_Class.C(TTree *tree)
{
...
MB_efficiency_Class.C::~MB_efficiency_Class.C()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MB_efficiency_Class.C::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MB_efficiency_Class.C::LoadTree(Long64_t entry)
{
...
void MB_efficiency_Class.C::Init(TTree *tree)
{
...
Bool_t MB_efficiency_Class.C::Notify()
{
...
void MB_efficiency_Class.C::Show(Long64_t entry)
{
...
Int_t MB_efficiency_Class.C::Cut(Long64_t entry)
{
...
#endif // #ifdef MB_efficiency_Class.C_cxx

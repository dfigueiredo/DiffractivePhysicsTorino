...
#ifndef Fraction_n_vertexes_Class_h
#define Fraction_n_vertexes_Class_h
...
class Fraction_n_vertexes_Class {
public :
 ...
 //vector<double>  distance;
   ...
   Fraction_n_vertexes_Class(TTree *tree=0);
   virtual ~Fraction_n_vertexes_Class();
...
#ifdef Fraction_n_vertexes_Class_cxx
Fraction_n_vertexes_Class::Fraction_n_vertexes_Class(TTree *tree)
{
...
Fraction_n_vertexes_Class::~Fraction_n_vertexes_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Fraction_n_vertexes_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Fraction_n_vertexes_Class::LoadTree(Long64_t entry)
{
...
void Fraction_n_vertexes_Class::Init(TTree *tree)
{
...
Bool_t Fraction_n_vertexes_Class::Notify()
{
...
void Fraction_n_vertexes_Class::Show(Long64_t entry)
{
...
Int_t Fraction_n_vertexes_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef Fraction_n_vertexes_Class_cxx

...
// Tue Mar 22 16:32:19 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/MBPythiaZ2_v1_7.root
//////////////////////////////////////////////////////////

#ifndef MB_efficiency_II.Class_h
#define MB_efficiency_II.Class_h
...
public :
 ...
 //vector<double>  etaOfTracksPT_gen;
   ...
   MB_efficiency_II.Class(TTree *tree=0);
   virtual ~MB_efficiency_II.Class();
...
#ifdef MB_efficiency_II.Class_cxx
MB_efficiency_II.Class::MB_efficiency_II.Class(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/MBPythiaZ2_v1_7.root");
      if (!f) {
         f = new TFile("files/MBPythiaZ2_v1_7.root");
      }
...
MB_efficiency_II.Class::~MB_efficiency_II.Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MB_efficiency_II.Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MB_efficiency_II.Class::LoadTree(Long64_t entry)
{
...
void MB_efficiency_II.Class::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Mx", &Mx, &b_Rootuple_Mx);
...
Bool_t MB_efficiency_II.Class::Notify()
{
...
void MB_efficiency_II.Class::Show(Long64_t entry)
{
...
Int_t MB_efficiency_II.Class::Cut(Long64_t entry)
{
...
#endif // #ifdef MB_efficiency_II.Class_cxx

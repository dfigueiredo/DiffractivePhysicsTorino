...
// Mon Mar 21 18:31:59 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/MBPythiaZ2_v1_7.root
//////////////////////////////////////////////////////////

#ifndef MB_efficiency_Class_h
#define MB_efficiency_Class_h
...
public :
 ...
 //vector<double>  distance;
   ...
   vector<Double_t>  etaOfTracksPT_gen;
   ...
   MB_efficiency_Class(TTree *tree=0);
   virtual ~MB_efficiency_Class();
...
#ifdef MB_efficiency_Class_cxx
MB_efficiency_Class::MB_efficiency_Class(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/MBPythiaZ2_STD_v1_8.root");
      if (!f) {
         f = new TFile("files/MBPythiaZ2_STD_v1_8.root");
      }
...
MB_efficiency_Class::~MB_efficiency_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MB_efficiency_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MB_efficiency_Class::LoadTree(Long64_t entry)
{
...
void MB_efficiency_Class::Init(TTree *tree)
{
...
Bool_t MB_efficiency_Class::Notify()
{
...
void MB_efficiency_Class::Show(Long64_t entry)
{
...
Int_t MB_efficiency_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef MB_efficiency_Class_cxx

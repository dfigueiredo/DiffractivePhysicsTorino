...
// Fri Jun 10 20:10:12 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/2011.root
//////////////////////////////////////////////////////////

#ifndef Analisys_2011_h
#define Analisys_2011_h
...
public :
 ...
 //vector<double>  etaOfTracksPT_gen;
   ...
   Int_t           PU_NumInt;
 //DifNtuple       PU_zpos;
 //DifNtuple       PU_ntrks_lowpT;
 //DifNtuple       PU_ntrks_highpT;
 //DifNtuple       PU_sumpT_lowpT;
 //DifNtuple       PU_sumpT_highpT;
   ...
   Analisys_2011(TTree *tree=0);
   virtual ~Analisys_2011();
...
#ifdef Analisys_2011_cxx
Analisys_2011::Analisys_2011(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/2011.root");
      if (!f) {
         f = new TFile("files/2011.root");
         f->cd("Rint:/");
      }
...
Analisys_2011::~Analisys_2011()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Analisys_2011::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analisys_2011::LoadTree(Long64_t entry)
{
...
void Analisys_2011::Init(TTree *tree)
{
...
void Analisys_2011::Show(Long64_t entry)
{
...
Int_t Analisys_2011::Cut(Long64_t entry)
{

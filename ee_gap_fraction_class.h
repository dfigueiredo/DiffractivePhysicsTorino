...
// Fri Jan 28 14:11:21 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/ZetaSkimA_ee_DL10.root
//////////////////////////////////////////////////////////

#ifndef ee_gap_fraction_class_h
#define ee_gap_fraction_class_h
...
public :
 ...
 //vector<double>  vertexChiNorm;
   ...
   ee_gap_fraction_class(TTree *tree=0);
   virtual ~ee_gap_fraction_class();
...
#ifdef ee_gap_fraction_class_cxx
ee_gap_fraction_class::ee_gap_fraction_class(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/ZetaSkimA_ee_DL10.root");
      if (!f) {
         f = new TFile("files/ZetaSkimA_ee_DL10.root");
      }
...
ee_gap_fraction_class::~ee_gap_fraction_class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ee_gap_fraction_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ee_gap_fraction_class::LoadTree(Long64_t entry)
{
...
void ee_gap_fraction_class::Init(TTree *tree)
{
...
Bool_t ee_gap_fraction_class::Notify()
{
...
void ee_gap_fraction_class::Show(Long64_t entry)
{
...
Int_t ee_gap_fraction_class::Cut(Long64_t entry)
{
...
#endif // #ifdef ee_gap_fraction_class_cxx

...
// Tue Feb  1 12:25:41 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/pythiaD6T_ee_v1.root
//////////////////////////////////////////////////////////

#ifndef EEfit_PythiaPomData_v1_Class_h
#define EEfit_PythiaPomData_v1_Class_h
...
class EEfit_PythiaPomData_v1_Class {
public :
 ...
 //vector<double>  vertexMolteplicity;
   ...
   EEfit_PythiaPomData_v1_Class(TTree *tree=0);
   virtual ~EEfit_PythiaPomData_v1_Class();
...
#ifdef EEfit_PythiaPomData_v1_Class_cxx
EEfit_PythiaPomData_v1_Class::EEfit_PythiaPomData_v1_Class(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/pythiaD6T_ee_v1.root");
      if (!f) {
         f = new TFile("files/pythiaD6T_ee_v1.root");
      }
...
EEfit_PythiaPomData_v1_Class::~EEfit_PythiaPomData_v1_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EEfit_PythiaPomData_v1_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EEfit_PythiaPomData_v1_Class::LoadTree(Long64_t entry)
{
...
void EEfit_PythiaPomData_v1_Class::Init(TTree *tree)
{
...
Bool_t EEfit_PythiaPomData_v1_Class::Notify()
{
...
void EEfit_PythiaPomData_v1_Class::Show(Long64_t entry)
{
...
Int_t EEfit_PythiaPomData_v1_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef EEfit_PythiaPomData_v1_Class_cxx

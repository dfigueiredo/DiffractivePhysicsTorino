...
// Wed Jun  1 19:23:59 2011 by ROOT version 5.18/00
...
Int_t 2011::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t 2011::LoadTree(Long64_t entry)
{

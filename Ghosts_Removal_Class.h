...
// Wed Feb  9 09:02:47 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/ZetaSkimB_ee_DL10.root
//////////////////////////////////////////////////////////

#ifndef Ghosts_Removal_Class_h
#define Ghosts_Removal_Class_h
...
public :
 ...
 //DifNtuple       *Rootuple;
   ...
   Ghosts_Removal_Class(TTree *tree=0);
   virtual ~Ghosts_Removal_Class();
...
#ifdef Ghosts_Removal_Class_cxx
Ghosts_Removal_Class::Ghosts_Removal_Class(TTree *tree)
{
...
Ghosts_Removal_Class::~Ghosts_Removal_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Ghosts_Removal_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Ghosts_Removal_Class::LoadTree(Long64_t entry)
{
...
void Ghosts_Removal_Class::Init(TTree *tree)
{
...
Bool_t Ghosts_Removal_Class::Notify()
{
...
void Ghosts_Removal_Class::Show(Long64_t entry)
{
...
Int_t Ghosts_Removal_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef Ghosts_Removal_Class_cxx

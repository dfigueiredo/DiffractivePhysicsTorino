...
// Mon Jan 24 15:02:12 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/Dat_JPsiee_Sep.root
//////////////////////////////////////////////////////////
...
public :
 ...
 //vector<double>  vertexMolteplicity;
   ...
   Double_t        vertexNumberOfRecHits;
   Int_t           PixelRHSize;
   Double_t        xL_gen;
   ...
   TBranch        *b_DiffRootuple_eMaxParticle_gen;   //!
   TBranch        *b_DiffRootuple_nTracks_gen;   //!
   TBranch        *b_DiffRootuple_CastoTotalEnergyTh;   //!
   TBranch        *b_DiffRootuple_sumECastor_Th_minus;   //!
   TBranch        *b_DiffRootuple_numberOfElectrons;   //!
   TBranch        *b_DiffRootuple_etaZed;   //!
   TBranch        *b_DiffRootuple_xi_PF_NOHF_minus;   //!
   TBranch        *b_DiffRootuple_xi_PF_NOHF_plus;   //!
   TBranch        *b_DiffRootuple_CastorActivity;   //!
   TBranch        *b_DiffRootuple_vertexNumberOfRecHits;   //!
   TBranch        *b_DiffRootuple_PixelRHSize;   //!
   TBranch        *b_DiffRootuple_xL_gen;   //!
   TBranch        *b_DiffRootuple_xL_Type_gen;   //!

   JPsi_gap(TTree *tree=0);
   virtual ~JPsi_gap();
...
#ifdef JPsi_gap_cxx
JPsi_gap::JPsi_gap(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/Dat_JPsiee_Sep.root");
      if (!f) {
         f = new TFile("files/Dat_JPsiee_Sep.root");
      }
...
Int_t JPsi_gap::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t JPsi_gap::LoadTree(Long64_t entry)
{
...
void JPsi_gap::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("eMaxParticle_gen", &eMaxParticle_gen, &b_DiffRootuple_eMaxParticle_gen);
   ...
   fChain->SetBranchAddress("numberOfElectrons", &numberOfElectrons, &b_DiffRootuple_numberOfElectrons);
   fChain->SetBranchAddress("etaZed", &etaZed, &b_DiffRootuple_etaZed);
   fChain->SetBranchAddress("xi_PF_NOHF_minus", &xi_PF_NOHF_minus, &b_DiffRootuple_xi_PF_NOHF_minus);
   fChain->SetBranchAddress("xi_PF_NOHF_plus", &xi_PF_NOHF_plus, &b_DiffRootuple_xi_PF_NOHF_plus);
   fChain->SetBranchAddress("CastorActivity", &CastorActivity, &b_DiffRootuple_CastorActivity);
   fChain->SetBranchAddress("vertexNumberOfRecHits", &vertexNumberOfRecHits, &b_DiffRootuple_vertexNumberOfRecHits);
   fChain->SetBranchAddress("PixelRHSize", &PixelRHSize, &b_DiffRootuple_PixelRHSize);
   fChain->SetBranchAddress("xL_gen", &xL_gen, &b_DiffRootuple_xL_gen);
   fChain->SetBranchAddress("xL_Type_gen", &xL_Type_gen, &b_DiffRootuple_xL_Type_gen);
   Notify();
}

Bool_t JPsi_gap::Notify()
{
...
void JPsi_gap::Show(Long64_t entry)
{
...
Int_t JPsi_gap::Cut(Long64_t entry)
{

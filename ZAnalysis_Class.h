...
// Fri Oct 14 15:58:31 2011 by ROOT version 5.30/02
...
#ifdef ZAnalysis_Class_cxx
ZAnalysis_Class::ZAnalysis_Class(TTree *tree)
{
...
ZAnalysis_Class::~ZAnalysis_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ZAnalysis_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZAnalysis_Class::LoadTree(Long64_t entry)
{
...
void ZAnalysis_Class::Init(TTree *tree)
{
...
void ZAnalysis_Class::Show(Long64_t entry)
{
...
Int_t ZAnalysis_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef ZAnalysis_Class_cxx

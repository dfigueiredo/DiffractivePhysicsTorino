...
// Mon Feb 14 17:25:08 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/ZetaSkimA_ee_DL10.root
//////////////////////////////////////////////////////////

#ifndef Fraction_n_vertexes_Class_2011_h
#define Fraction_n_vertexes_Class_2011_h
...
class Fraction_n_vertexes_Class_2011 {
public :
 ...
 //vector<double>  distance;
   ...
   Double_t        PV_z;
   Double_t        etaZ_gen;
   vector<Double_t>  electronEnergy;
   vector<Double_t>  muEnergy;
   //   Bool_t          hltMatch;
   ...
   //   TBranch        *b_Rootuple_hltMatch;   //!


   Fraction_n_vertexes_Class_2011(TTree *tree=0);
   virtual ~Fraction_n_vertexes_Class_2011();
...
#ifdef Fraction_n_vertexes_Class_2011_cxx
Fraction_n_vertexes_Class_2011::Fraction_n_vertexes_Class_2011(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/SkimA_mm_DAV_v1_8.root");
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/SkimA_sm_DAV_v1_11.root");
     if (!f) {
       //     f = new TFile("files/SkimA_mm_DAV_v1_8.root");
     f = new TFile("files/SkimA_sm_DAV_v1_11.root");
     }
...
Fraction_n_vertexes_Class_2011::~Fraction_n_vertexes_Class_2011()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Fraction_n_vertexes_Class_2011::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Fraction_n_vertexes_Class_2011::LoadTree(Long64_t entry)
{
// Set the environment to read one entry
   if (!fChain) return -5;
   Long64_t centry = fChain->LoadTree(entry);
   if (centry < 0) return centry;
   if (!fChain->InheritsFrom(TChain::Class_2011()))  return centry;
...
void Fraction_n_vertexes_Class_2011::Init(TTree *tree)
{
   ...
   //   fChain->SetBranchAddress("hltMatch", &hltMatch, &b_Rootuple_hltMatch);

   Notify();
}

Bool_t Fraction_n_vertexes_Class_2011::Notify()
{
...
void Fraction_n_vertexes_Class_2011::Show(Long64_t entry)
{
...
Int_t Fraction_n_vertexes_Class_2011::Cut(Long64_t entry)
{
...
#endif // #ifdef Fraction_n_vertexes_Class_2011_cxx

...
// Mon May 16 08:35:51 2011 by ROOT version 5.18/00
// from TTree tree_/tree_
// found on file: files/SelectedRootuplaPU.root
//////////////////////////////////////////////////////////

#ifndef MC_PU_Class_h
#define MC_PU_Class_h
...
public :
 ...
 //vector<double>  muEnergy;
   Int_t           PU_NumInt;
   vector<Float_t>   PU_zpos;
   vector<Float_t>   PU_sumpT_lowpT;
   vector<Float_t>   PU_sumpT_highpT;
   ...
   TBranch        *b_Rootuple_hlt9Match;   //!
   TBranch        *b_Rootuple_hlt20Match;   //!
...
#ifdef MC_PU_Class_cxx
MC_PU_Class::MC_PU_Class(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     //      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/SelectedRootuplaPU.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("files/MCWtoenu_P6DW_PU2010_v1_16.root");
      if (!f) {
	//         f = new TFile("files/SelectedRootuplaPU.root");
         f = new TFile("files/MCWtoenu_P6DW_PU2010_v1_16.root");
      }
...
MC_PU_Class::~MC_PU_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MC_PU_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_PU_Class::LoadTree(Long64_t entry)
{
...
void MC_PU_Class::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("hlt9Match", &hlt9Match, &b_Rootuple_hlt9Match);
   fChain->SetBranchAddress("hlt20Match", &hlt20Match, &b_Rootuple_hlt20Match);
...
void MC_PU_Class::Show(Long64_t entry)
{
...
Int_t MC_PU_Class::Cut(Long64_t entry)
{

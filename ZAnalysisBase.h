...
// Thu Mar 22 09:48:53 2012 by ROOT version 5.30/02
...
public :
 ...
 //DifNtuple       *Rootuple;
   ...
   Double_t        max_eta_gap_gen;
   Double_t        max_second_eta_gap_gen;
   Double_t        eta_gap_limplus_gen;
   Double_t        Mx2;
   Double_t        Mx2_plus;
   Double_t        Mx2_minus;
   Double_t        P_x;
   ...
   Double_t        Mx2_plus_gen;
   Double_t        Mx2_minus_gen;
   Int_t           nTowersHF_plus;
   Int_t           nTowersHF_minus;
   Double_t        sumEHF_plus;
   Double_t        sumEHF_minus;
   Double_t        sumEHF_L_plus;
   Double_t        sumEHF_L_minus;
   Double_t        sumEHF_S_plus;
   Double_t        sumEHF_S_minus;
   ...
   vector<float>   EnergyInEtaHFL;
   vector<float>   EnergyInEtaHFS;
   vector<float>   EnergyCastorModule;
   ...
   TBranch        *b_Rootuple_max_eta_gap_gen;   //!
   TBranch        *b_Rootuple_max_second_eta_gap_gen;   //!
   TBranch        *b_Rootuple_eta_gap_limplus_gen;   //!
   ...
   TBranch        *b_Rootuple_Mx2_plus_gen;   //!
   TBranch        *b_Rootuple_Mx2_minus_gen;   //!
   ...
   TBranch        *b_Rootuple_sumEHF_L_plus;   //!
   TBranch        *b_Rootuple_sumEHF_L_minus;   //!
   TBranch        *b_Rootuple_sumEHF_S_plus;   //!
   TBranch        *b_Rootuple_sumEHF_S_minus;   //!
   ...
   TBranch        *b_Rootuple_N_mx2plus_gen;   //!
   TBranch        *b_Rootuple_N_mx2minus_gen;   //!
   ...
   TBranch        *b_Rootuple_EnergyInEtaHFL;   //!
...
void ZAnalysisBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("max_eta_gap_gen", &max_eta_gap_gen, &b_Rootuple_max_eta_gap_gen);
   fChain->SetBranchAddress("max_second_eta_gap_gen", &max_second_eta_gap_gen, &b_Rootuple_max_second_eta_gap_gen);
   fChain->SetBranchAddress("eta_gap_limplus_gen", &eta_gap_limplus_gen, &b_Rootuple_eta_gap_limplus_gen);
   ...
   fChain->SetBranchAddress("Mx2_plus_gen", &Mx2_plus_gen, &b_Rootuple_Mx2_plus_gen);
   fChain->SetBranchAddress("Mx2_minus_gen", &Mx2_minus_gen, &b_Rootuple_Mx2_minus_gen);
   ...
   fChain->SetBranchAddress("sumEHF_L_plus", &sumEHF_L_plus, &b_Rootuple_sumEHF_L_plus);
   fChain->SetBranchAddress("sumEHF_L_minus", &sumEHF_L_minus, &b_Rootuple_sumEHF_L_minus);
   fChain->SetBranchAddress("sumEHF_S_plus", &sumEHF_S_plus, &b_Rootuple_sumEHF_S_plus);
   fChain->SetBranchAddress("sumEHF_S_minus", &sumEHF_S_minus, &b_Rootuple_sumEHF_S_minus);
   ...
   fChain->SetBranchAddress("N_mx2plus_gen", &N_mx2plus_gen, &b_Rootuple_N_mx2plus_gen);
   fChain->SetBranchAddress("N_mx2minus_gen", &N_mx2minus_gen, &b_Rootuple_N_mx2minus_gen);
   ...
   fChain->SetBranchAddress("EnergyInEtaHFL", &EnergyInEtaHFL, &b_Rootuple_EnergyInEtaHFL);
   fChain->SetBranchAddress("EnergyInEtaHFS", &EnergyInEtaHFS, &b_Rootuple_EnergyInEtaHFS);
   fChain->SetBranchAddress("EnergyCastorModule", &EnergyCastorModule, &b_Rootuple_EnergyCastorModule);
   Notify();
}
